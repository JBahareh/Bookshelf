  ...
  return (
    ...
    >
      <Container>
        ...
        >
          <img
            src="https://newcdn.fidibo.com/img/nd-header-logo.svg"
            alt="bookshelf"
            style={{
              padding: "15px",
              marginTop: "10",
            ...
            >
              {({ TransitionProps }) => (
                <Fade {...TransitionProps} timeout={350}>
                  <Paper>
                    <Typography sx={{ p: 2 }}>
                      برای آغاز جستجو حداقل دو حرف تایپ کنید
                    </Typography>
                  </Paper>
                </Fade>
              )}
          ...
          <div style={{ color: "#919391", marginTop: "13px" }}>
            <IconButton
              onMouseEnter={() => {
                setIsHover(true);
              }}
              style={{ color: isHover ? "black" : "#8a8a8a" }}
            >
              <FontAwesomeIcon icon={faGift} fontSize="large" />
            </IconButton>
            <IconButton
              onMouseEnter={() => {
                setIsHover(true);
